...
def generate_diff(pathfile1, pathfile2, formater='stylish'):
    ...
    diff_list = make_diff(file_data1, file_data2)

    return format_name(diff_list)
